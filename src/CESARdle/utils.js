...
function changeStatsStyles() {
    ...
    winStreak.style.transform = 'translateY(0)' 
    gamesAmount.style.transform = 'translateY(0)' 
    winPercentual.style.transform = 'translateY(0)' 
    winStreak.firstElementChild.style.transform = 'scale(1)' 
    gamesAmount.firstElementChild.style.transform = 'scale(1)' 
    winPercentual.firstElementChild.style.transform = 'scale(1)' 
}
...
function resetStatsStyles() {
    ...
    winStreak.firstElementChild.style.transform = '' 
    gamesAmount.firstElementChild.style.transform = '' 
    winPercentual.firstElementChild.style.transform = '' 
}
